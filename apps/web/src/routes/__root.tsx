  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10 text-foreground sm:px-6">
      <div className="pointer-events-none absolute inset-0 opacity-80">
        ...
        <div className="absolute inset-y-0 right-0 w-72 bg-[radial-gradient(28rem_18rem_at_right,color-mix(in_srgb,var(--color-emerald-500)_10%,transparent),transparent)]" />
        <div className="absolute inset-0 bg-[linear-gradient(145deg,color-mix(in_srgb,var(--background)_90%,var(--color-black))_0%,var(--background)_55%)]" />
      </div>
      ...
      <section className="relative w-full max-w-xl rounded-2xl border border-border/80 bg-card/90 p-6 shadow-2xl shadow-black/20 backdrop-blur-md sm:p-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          Waiting for the local backend and session bootstrap to finish.
        </p>
      </section>
    </div>
  );

  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new polarish prerelease is available for nightly testers."
          : "A new polarish latest release is available.",
...
).pipe(Command.withDescription("Post a polarish release announcement to Discord."));
